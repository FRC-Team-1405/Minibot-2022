...
public class DriveBaseController extends CommandBase {
  private DoubleSupplier driveSpeed;
  private DoubleSupplier driveRotation;
  private ArcadeDrive driveBase;
  
  public DriveBaseController(DoubleSupplier driveSpeed, DoubleSupplier driveRotation, ArcadeDrive driveBase) {
